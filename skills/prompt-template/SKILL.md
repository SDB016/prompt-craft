...
description: "[DEPRECATED] Use /coach template instead. Redirects automatically."
---

> **Deprecated:** `/prompt-template` has been renamed to `/coach template` in Prompt Craft v2.0.
...
2. Immediately invoke the new skill using the Skill tool: `skill: "coach"`, `args: "template $ARGUMENTS"`
