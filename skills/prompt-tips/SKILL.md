---
name: prompt-tips
description: "[DEPRECATED] Use /coach instead. Redirects automatically."
---

> **Deprecated:** `/prompt-tips` has been renamed to `/coach` in Prompt Craft v2.0.
...
2. Immediately invoke the new skill using the Skill tool: `skill: "coach"`, `args: "$ARGUMENTS"`
