---
name: setup
description: "[DEPRECATED] Use /review --doctor instead. Redirects automatically."
---

> **Deprecated:** `/setup` has been renamed to `/review --doctor` in Prompt Craft v2.0.
...
2. Immediately invoke the new skill using the Skill tool: `skill: "review"`, `args: "--doctor $ARGUMENTS"`
