---
name: prompt-review
description: "[DEPRECATED] Use /review instead. Redirects automatically."
---

> **Deprecated:** `/prompt-review` has been renamed to `/review` in Prompt Craft v2.0.
...
2. Immediately invoke the new skill using the Skill tool: `skill: "review"`, `args: "$ARGUMENTS"`
